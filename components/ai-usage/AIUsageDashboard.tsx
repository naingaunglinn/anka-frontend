        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-[#e6e9ee] shadow-sm overflow-hidden">
                <div className="p-6 border-b border-[#e6e9ee]">
                    <h3 className="text-lg font-semibold text-[#171717]">Recent AI Calls</h3>
                    <p className="text-sm text-[#4a4a4a] mt-0.5">Last 100 calls. Model: Claude Haiku 4.5.</p>
                </div>
                <Table>
                    <TableHeader>
                        <TableRow>
    ...
    return (
        <div className="space-y-6 mt-8">
            <div>
                ...
                <p className="text-sm text-[#4a4a4a] mt-1">Aggregate Claude API usage across the platform.</p>
            </div>
                    ...
                    <TableBody>
                        {tenants.length === 0 ? (
                            ...
                            <TableRow key={t.tenantId}>
                                <TableCell className="font-medium text-[#171717]">{t.tenantName}</TableCell>
                                <TableCell className="text-right">{t.totalCalls.toLocaleString()}</TableCell>
                                <TableCell className="text-right text-sm text-[#4a4a4a]">{t.totalInputTokens.toLocaleString()}</TableCell>
                                <TableCell className="text-right text-sm text-[#4a4a4a]">{t.totalOutputTokens.toLocaleString()}</TableCell>
