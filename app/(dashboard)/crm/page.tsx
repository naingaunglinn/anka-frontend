            ...
            <div className="flex-1 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                {dealsQuery.isLoading ? (
                    ...
                    <div className="flex h-96 flex-col items-center justify-center gap-3 text-center">
                        <p className="text-sm font-medium text-slate-900">Could not load pipeline deals.</p>
                        <Button variant="outline" onClick={() => dealsQuery.refetch()}>Retry</Button>
                    </div>
                ) : deals.length === 0 ? (
                    <div className="flex h-96 flex-col items-center justify-center gap-3 text-center">
                        <p className="text-sm text-slate-500">No deals yet. Create your first deal to start the pipeline.</p>
                        <Link href="/crm/new">
                            <Button>
                                <Plus className="mr-2 h-4 w-4" /> New Deal
                            </Button>
