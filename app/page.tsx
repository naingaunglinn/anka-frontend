  ...
  return (
    <main className="bg-[#f8fafc] text-[#171717]">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[#e6e9ee] bg-[#f8fafc]/85 backdrop-blur-xl">
        <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between px-6 md:px-10">
          ...
          <nav className="hidden items-center gap-8 text-sm text-[#4a4a4a] md:flex">
            <a href="#features" className="hover:text-[#00a7f4]">{t('nav_features')}</a>
            <a href="#ai" className="hover:text-[#00a7f4]">{t('nav_ai_features')}</a>
            <a href="#how" className="hover:text-[#00a7f4]">{t('nav_how_it_works')}</a>
            <a href="#modules" className="hover:text-[#00a7f4]">{t('nav_modules')}</a>
          </nav>
          <div className="flex items-center gap-3">
            <LocaleSwitcher />
            <Link href="/login" className="inline-flex items-center gap-2 rounded-full bg-[#171717] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-[#00a7f4]">
              {t('sign_in_short')}
      ...
      <section className="relative overflow-hidden px-6 pb-20 pt-36 md:px-10 md:pt-44">
        ...
        <div className="mx-auto w-full max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#00a7f4]/10 px-4 py-2 text-xs uppercase tracking-[0.18em] text-[#0086c4]">
            <span className="h-2 w-2 rounded-full bg-[#00a7f4]" /> {t('agency_management_platform')}
          </div>
          <h1 className="text-5xl font-semibold leading-[0.95] tracking-[-0.03em] md:text-7xl">
            {t('hero_title_run')}<br />
            <span className="text-[#00a7f4]">{t('hero_title_pipeline_to_profit')}</span>
          </h1>
          <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-[#4a4a4a]">
            {t('hero_subtitle')}
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/login" className="inline-flex items-center gap-2 rounded-full bg-[#171717] px-6 py-3 text-sm font-semibold text-white hover:bg-[#00a7f4]">
      ...
      <section id="ai" className="mx-auto w-full max-w-7xl px-6 py-24 md:px-10">
        <p className="mb-3 font-mono text-xs uppercase tracking-[0.18em] text-[#0086c4]">{t('ai_powered_label')}</p>
        <h2 className="max-w-3xl text-4xl font-semibold tracking-tight md:text-6xl">{t('ai_section_heading')}</h2>
        <p className="mt-5 max-w-3xl text-lg text-[#4a4a4a]">{t('ai_section_subtitle')}</p>
      ...
      <section id="modules" className="bg-white px-6 py-24 md:px-10 border-y border-[#e6e9ee]">
        <div className="mx-auto w-full max-w-7xl">
          <p className="mb-3 font-mono text-xs uppercase tracking-[0.18em] text-[#0086c4]">{t('platform_modules_label')}</p>
      ...
      <section id="how" className="bg-[#171717] px-6 py-24 text-[#f8fafc] md:px-10">
        <div className="mx-auto w-full max-w-7xl">
          <p className="mb-3 font-mono text-xs uppercase tracking-[0.18em] text-[#00a7f4]">{t('the_flow_label')}</p>
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid gap-8 md:grid-cols-5">
            <div className="md:col-span-2">
              ...
              <p className="mt-3 max-w-sm text-sm text-[#4a4a4a]">{t('footer_tagline')}</p>
            </div>
...
function Step({ n, stepLabel, title, text }: { n: string; stepLabel: string; title: string; text: string }) {
  return (
    <article className="border-l border-[#00a7f4]/35 pl-5">
      <p className="mb-2 font-mono text-xs uppercase tracking-[0.14em] text-[#00a7f4]">{stepLabel} {n}</p>
